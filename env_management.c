...
/**
 * env_get_key - retrives the value of an environment variable
...
/**
 * env_remove_key - eliminate a key from the environment
...
/**
 * print_environ - displays the current environ
 * @data: program's data struct
 * Return: nothing
 */
