...
/**
 * builtin_exit - terminate program with given status
...
/**
 * builtin_cd - alter the present working directory
...
/**
 * set_work_directory - specify working directory
 * @data: program's data struct
 * @new_dir: path designated as working directory
 * Return: zero if success, or other number if its declared in the arguments
 */
...
/**
 * builtin_help - displays the environment in which the shell is operating
 * @data: program's data struct
 * Return: zero if success, or other number if its declared in the arguments
 */
...
/**
 * builtin_alias - include, remove or display aliases
 * @data: program's data struct
 * Return: zero if success, or other number if its declared in the arguments
 */
