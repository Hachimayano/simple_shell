...
/**
 * str_compare - Combines two strings
 * @string1: First string, shorter
 * @string2: Second string, longer
...
/**
 * str_reverse - inverts the order of a string.
 *
 * @string: string represented by a pointer.
 * Return: void.
 */
