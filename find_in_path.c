...
/**
 * find_program - locate a program in path
...
/**
 * tokenize_path - split the path in directories
 * @data: a pointer to the program's data
 * Return: array containing path directories
 */
 ...
 * @full_path: pointer to complete file name
