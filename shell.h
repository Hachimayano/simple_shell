...
#include <sys/stat.h> /* stat function usage */
 ...
 * @input_line: pointer for reading input in _getline
 * @command_name: pointer to initial command entered by user
 * @exec_counter: count of executed commands
 * @file_descriptor: file descriptor pointing to input of commands
 * @tokens: tokenized input array pointer
 ...
 * @function: corresponding func to be invoked for each builtin
 */
...
/* Initialize struct with program info */
void initialize_data(data_of_program *data, int arc, char *argv[], char **env);

/* Creates an endless loop displaying the prompt*/
void detty(char *prompt, data_of_program *data);
...
/* Retrieve a single line from standard output*/
int _getline(data_of_program *data);

/* split each line for the presence of logical operators, if they exist */
